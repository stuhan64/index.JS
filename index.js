...
app.post('/upload-design', async (req, res) => {
  try {
    ...
    if (type === 'trio') {
      ...
      // Trim transparent padding then resize — keeps glyph filling the full box
...
// Toddler tee Printful variant IDs
...
app.post('/webhook-order', async (req, res) => {
  try {
    ...
    const updatedItems = sortedPfItems.map((pfItem, index) => {
      ...
      // Toddler tee wheel sits slightly lower than adult/bodysuit
