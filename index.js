...
const gapA  = 2;   // Rising to line 1
const gapB  = 1;   // line 1 to Sun
const gapC  = 1;   // Sun to line 2
const gapD  = 2;   // line 2 to Moon
...
function shopifyToPrintfulVariant(shopifyVariantId) {
  ...
  const map = {
    ...
    "53080458166569": 5288294400,
    "53080458199337": 5288294401,
    "53080458232105": 5288294402,
    // Toddler Jersey T-Shirt (both trio and wheel use same product)
    "53097308881193": 5288294403,
    "53097308913961": 5288294404,
    "53097308946729": 5288294405,
    "53097308979497": 5288294406
  };
  return map[id] || null;
}
